...
@implementation TGBResultSet
@synthesize query=_query;
@synthesize statement=_statement;

+ (instancetype)resultSetWithStatement:(LCStatement *)statement usingParentDatabase:(TGBDatabase*)aDB {
    
    TGBResultSet *rs = [[TGBResultSet alloc] init];
...
- (void)setParentDB:(TGBDatabase *)newDb {
    _parentDB = newDb;
}
