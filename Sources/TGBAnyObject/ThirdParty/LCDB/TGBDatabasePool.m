...
@interface TGBDatabasePool()

- (void)pushDatabaseBackInPool:(TGBDatabase*)db;
- (TGBDatabase*)db;

@end


@implementation TGBDatabasePool
...
//                    NSLog(@"Maximum number of databases (%ld) has already been reached!", (long)currentCount);
            ...
            db = [TGBDatabase databaseWithPath:self->_path];
