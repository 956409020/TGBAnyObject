...
/*! @abstract 123: Invalid ACL. An ACL with an invalid format was saved. This should not happen if you use TGBACL. */
...
typedef void (^TGBObjectResultBlock)(TGBObject * _Nullable object, NSError * _Nullable error);
typedef void (^AVSetResultBlock)(NSSet * _Nullable channels, NSError * _Nullable error);
typedef void (^TGBUseredResultBlock)(TGBUsered * _Nullable user, NSError * _Nullable error);
...
typedef void (^TGBFileResultBlock)(TGBFile * _Nullable file, NSError * _Nullable error);
