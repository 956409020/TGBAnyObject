...
typedef NS_OPTIONS(NSUInteger, TGBFileUploadOption) {
    ...
    TGBFileUploadOptionCachingData = 0,
    
    /// Data or File will not be persistent cached after successfully uploading.
    TGBFileUploadOptionIgnoringCachingData = 1 << 0
};

typedef NS_OPTIONS(NSUInteger, TGBFileDownloadOption) {
    ...
    TGBFileDownloadOptionCachedData = 0,
    
    /// Always downloading from URL.
    TGBFileDownloadOptionIgnoringCachedData = 1 << 0
};
 ...
 */
@interface TGBFile : NSObject <NSCoding>
...
/**
 Create file from TGBObject
 
 @param TGBObject TGBObject
 @return Instance
 */
...
/**
 Upload Method. Use default option `TGBFileUploadOptionCachingData`.
...
/**
 ...
 @param uploadOption See `TGBFileUploadOption`
 @param uploadProgressBlock Upload Progress Block.
 @param completionHandler Completion Handler.
 */
...
/**
 Download Method. Use default option `TGBFileDownloadOptionCachedData`.
...
/**
 ...
 @param downloadOption See `TGBFileDownloadOption`.
 @param downloadProgressBlock Download Progress Block.
 @param completionHandler Completion Handler.
 */
...
/**
 ...
 if not set, TGBFile will use a default Persistent Cache Directory.
...
+ (void)getFileWithObjectId:(NSString *)objectId
          completionHandler:(void (^)(TGBFile * _Nullable file, NSError * _Nullable error))completionHandler;
...
/*!
 Create an TGBFileQuery which returns files.
 */
+ (TGBFileQuery *)query;
