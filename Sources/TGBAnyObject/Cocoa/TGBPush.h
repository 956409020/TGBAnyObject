...
extern NSString *const kTGBPushTargetPlatformIOS;
extern NSString *const kTGBPushTargetPlatformAndroid;
extern NSString *const kTGBPushTargetPlatformWindowsPhone;
...
/*!
 ...
 query should be created via [TGBInstallation query] and should not specify a
 skip, limit, or order.
 ...
 *         Value maybe in kTGBPushTargetPlatformIOS,kTGBPushTargetPlatformAndroid,kTGBPushTargetPlatformWindowsPhone
 */
...
/*!
 ...
 @param query The query to send to. The query must be a TGBInstallation query
 created with [TGBInstallation query].
 @param message The message to send.
 @param error Pointer to an NSError that will be set if necessary.
 @return whether the send succeeded.
 */
...
/*!
 An alias of `-[TGBPush sendPush:]` methods that supports Swift exception.
 @seealso `-[TGBPush sendPush:]`
 */
...
/*!
 An alias of `-[TGBPush getSubscribedChannels:]` methods that supports Swift exception.
 @seealso `-[TGBPush getSubscribedChannels:]`
 */
